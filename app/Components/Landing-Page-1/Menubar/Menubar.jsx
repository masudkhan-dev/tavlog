...
// next images
import logo1 from "@/public/Travlog assets/logo1.png";
      ...
      <li key={index} className="relative group">
        <Link
          ...
          className={`flex items-center cursor-pointer ${
            active
              ? "bg-[#F75E9F] text-white"
              : hasScrolled
              ? "hover:bg-[#F75E9F] hover:text-white"
              : "hover:bg-[#F75E9F] hover:text-white"
        ...
        <div className="flex items-center justify-between py-4">
          <div>
            <Link href="/" className="flex items-center gap-2">
              ...
              />
              <h2 className="text-2xl font-bolder text-black roboto">
                Travlog
              </h2>
            </Link>
          </div>
